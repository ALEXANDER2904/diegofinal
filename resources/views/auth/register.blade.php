...
@section('contenido')
    <div class="md:flex">
        <div class="md:w-7/12 flex items-center p-10">
            <img class="rounded-xl" src="{{asset('imagenes/registrolaese.jpg')}}" alt="imagen registrarse">
        </div>
        <div class="md:w-5/12 shadow-xl rounded-xl p-10 bg-gray-400">
            <form action="" method="POST">
                ...
                <div>
                    <input type="submit" value="Crear cuenta" class="p-3 bg-blue-500 w-full rounded-xl mt-3 font-bold text-white cursor-pointer hover:bg-gray-400 transition-colors uppercase">
                </div>
            </form>
        </div>
    </div>
