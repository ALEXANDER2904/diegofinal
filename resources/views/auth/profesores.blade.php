    ...
    <div class="md:flex">
        <div class="md:w-7/12 flex items-center p-2">
            ...
            <div class="w-full bg-gray-300 shadow-md rounded-md p-4">
                <h1 class="text-3xl font-bold mb-6 text-center border-b-">Listado de Profesores</h1>
                <table class="w-full border-collapse border -black">
                    <thead>
                        <tr>
                            <th class="color bg-gray-500">ID</th>
                            <th class="color bg-gray-500">Nombre</th>
                            <th class="color bg-gray-500">Apellidos</th>
                            <th class="color bg-gray-500">E-mail</th>
                            <th class="color bg-gray-500">Área</th>
                            <th class="color bg-gray-500">Acciones</th>
                        </tr>
                    </thead>
                    <tbody>
